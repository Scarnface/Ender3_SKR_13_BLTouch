...
#define STRING_CONFIG_H_AUTHOR "(Karl Hungus, Ender-3 Custom)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Custom"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION (Y_BED_SIZE - 45)
